...
// OpenGLMFC.cpp : Defines the class behaviors for the application.
//
...
// The one and only COpenGLMFCApp object

COpenGLMFCApp theApp;


// COpenGLMFCApp initialization
...
// COpenGLMFCApp message handlers
